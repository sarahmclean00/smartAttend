  ...
  ngOnInit() {
    ...
    this.authService.user$.subscribe(user => {
      ...
      this.webService.getUserDetails(this.userData).subscribe(userDetails=>{
        ...
        console.log('Dashboard User Details', this.userDetails)
    ...
    // this.attendance = this.webService.getDashboardAttendance(this.user_id, this.page)
    this.attended_modules_list = this.webService.getAttendedModules(this.userData);
    this.saved_modules_list = this.webService.getDashboardSavedModules(this.userData);
    this.future_saved_modules_list = this.webService.getDashboardFutureSavedModules(this.userData);


    })

    this.module_list = this.webService.getDashboardModules(this.page);  //  call the WebService
