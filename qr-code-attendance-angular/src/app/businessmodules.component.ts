...
@Component({
  templateUrl: 'economicsmodules.component.html'
})


export class EconomicsModulesComponent implements OnInit {
  ...
  ngOnInit(){
    ...
    this.module_list = this.webService.getEconomicsModules();
