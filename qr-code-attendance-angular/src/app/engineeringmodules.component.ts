...
@Component({
  templateUrl: 'engineeringmodules.component.html'
})


export class EngineeringModulesComponent implements OnInit {
  ...
  ngOnInit(){
    ...
    this.module_list = this.webService.getEngineeringModules();
