...
@Component({
  templateUrl: 'biologicalmodules.component.html'
})


export class BiologicalModulesComponent implements OnInit {
  ...
  ngOnInit(){
    ...
    this.module_list = this.webService.getBiologicalModules();
