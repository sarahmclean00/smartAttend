...
@Component({
  templateUrl: 'languagesmodules.component.html'
})


export class LanguagesModulesComponent implements OnInit {
  ...
  ngOnInit(){
    ...
    this.module_list = this.webService.getLanguageModules();
